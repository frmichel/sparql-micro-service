...
try {
    ...
    $context = Context::getInstance(Logger::NOTICE);
    ...
    if ($querymode == 'ld') {
        ...
        $logger->notice('Evaluating SPARQL query against temporary graph...');
    ...
    $logger->notice("Sending response Content-Type: " . $result->getHeader('Content-Type'));
