...
pass_multiple_values_as_csv | Optional | Define show multiple values of an service argument are passed to the Web API: true = as a comma-separated value, false = value is split and Web API is invoked once for each value. Default: true
